  ...
  import RevRevCourseSmallList from './RevRevCourseSmallList';
  import RevMapCourseSmallList from './RevMapCourseSmallList';
  import RevMiniCourseSmallList from './RevMiniCourseSmallList';
  ...
  export default function GetRevMap() {
  ...
  const [cartItem, setCartItem] = useState(0);
    ...
    // });
    useEffect(() => {
      if (window.location.href.indexOf("revenue-maps") === -1) {
        window.location.reload();
      }
    });
    useEffect(() => {
