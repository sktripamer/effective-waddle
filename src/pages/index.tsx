...
div.compare-today-container, div.compare-tomorrow-container {font-size: 18px;}
...
div.rev-optin:after {
  background: linear-gradient(
68deg,#3200838c 50%,rgb(35 35 35/5%));
}
...
#compare-container div.compare-today-container, #compare-container div.compare-tomorrow-container {font-size: 12px;}
...
div.journey-item div.j-paragraph {width: 100%;margin-right: 6.5%;margin-left: 6.5%;}

div.j-text {width: 90%;}

div.j-heading:first-child {font-size: 9.5vw;}

div.j-headingj1 {font-size: 6.2vw;}
...
div.j-headingj2 {font-size: 5.42vw;}

div.j-headingj3 {font-size: 4.55vw;}
...
.rev-optin:after {
  ...
  top: 0;
  background: linear-gradient(
    68deg,#320083e0 50%,rgb(35 35 35/5%));
}
...
.attr-option {margin-left:8px;width: 18px;height: 18px;cursor: pointer;    border-radius: 50%;}
...
.icons-container {display: flex;width: 100%;margin-top: 6em;margin-bottom: 5em;justify-content: center;
...
.icon-section:nth-child(2) {clip-path: polygon( 10% 0, /* left top */ 100% 0%, /* right top */ 100% 100%, /* right bottom */ 0 100% /* left bottom */ );margin-left: -5%;padding-right: 3%;padding-left: 5%;width: 35%;
...
clip-path: polygon(
    ...
    0 100% /* left bottom */
  );margin-left: 4%;padding-left: 2%;

background: linear-gradient(27deg, rgba(143,22,36,1) 0%, rgba(183,26,44,1) 70%);}

.icon-section:last-child {clip-path: polygon( 10% 0, /* left top */ 90% 0%, /* right top */ 90% 100%, /* right bottom */ 0% 100% /* left bottom */ );
    margin-left: -4%;padding-right: 4%;
    padding-left: 4%;background: linear-gradient(27deg, rgba(21,18,92,1) 0%, rgba(33,28,144,1) 70%);}
...
.icon-section:first-child > .icon-section-text {padding-right: 15%;}
...
.j-paragraph {width: 40%;margin-right: auto;margin-left: 6.5%;color: #76010b;}
...
.j-visible {font-family: 'Nunito Regular';}

.j-heading:first-child {font-size: 3.7vw;}

.j-first .j-paragraph {margin-top: -3em;}

.j-second .j-paragraph {margin-right: 4.5%;margin-left: auto;margin-top: -3em;}

.j-third .j-paragraph {margin-top: 3em;}

.j-first .typewrap1 {font-size: 2.4VW;
  white-space: nowrap;}

.j-second .typewrap2 {font-size: 2.4VW;
  white-space: nowrap;}
.j-third .typewrap3 {font-size: 2.4VW;
  white-space: nowrap;}
...
.y-image-contain {
  ...
  padding: 20px;
  margin-right: 20px;
  background: linear-gradient(286deg,#850be2,#c41ab8);
  border-radius: 20px;
...
.compare-title-container {
  ...
  position: relative;
  border-width: 5px;
  border-image-source: linear-gradient(90deg, rgba(50,12,227,1) 0%, rgba(224,10,45,1) 50%, rgba(50,12,227,1) 100%);
}
...
.compare-today-subtext {
  ...
  -webkit-text-fill-color: transparent;
  -webkit-background-clip: text;
  background-image: linear-gradient(90deg, rgba(50,12,227,1) 20%, rgba(224,10,45,1) 100%);
}
...
opacity: 0;
  ...
  -webkit-text-fill-color: transparent;
  -webkit-background-clip: text;
  background-image: linear-gradient(270deg, rgba(50,12,227,1) 20%, rgba(224,10,45,1) 100%);
}
.compare-title-vs {
  font-family: 'Josefin Sans';
  font-size: 24px;
...
.preorder-btn-container.true {
  ...
  background-image: linear-gradient(155deg,rgba(201,34,40,.8),rgba(209,0,52,.8) 11%,rgba(219,0,73,.8) 22%,rgba(219,0,91,.8) 33%,rgba(219,0,113,.8) 44%,rgba(209,0,139,.8) 56%,rgba(194,0,165,.8) 67%,rgba(171,0,194,.8) 78%,rgba(131,0,224,.8) 89%,rgba(33,29,252,.8));
  height: 100%;
  left: 0;
  position: absolute;
  top: 0;
...
text-indent: 10px;margin-bottom: .5rem;font-family: Nunito Regular;
color: #470006;
}

.modal-book-cont {margin-right: 0.8em;margin-left: 0.3em;}

.modal-book-title {font-family: 'JOSEFIN SANS';font-size: .8em;margin-top: 1em;color: #cc0213;}

.modal-book-title-text {font-family: 'JOSEFIN SANS';
  font-size: .6em;margin-top: .2em;margin-bottom: .7em;color: #cc0213;}
...
z-index:2;
width: 100%;
    transform: translateZ(1px) perspective(2000px);
    height: 96%;
    top: 2%;
...
transform: perspective(2000px) rotateY(-118deg);
}
...
-webkit-transform: perspective(2000px) rotateY(-33deg);
transform-style: preserve-3d;
-webkit-transform-style: preserve-3d;
box-shadow: 
  inset 4px 1px 3px #ffffff60,
...
.mini-product-cont {padding: 10px;width: 30%;}
...
.mini-product-cont img {width: 90%;margin-left: 5%;}

.mini-title {font-size: 24px;font-family: 'Nunito Bold';}
...
display: flex;
justify-content: space-between;
background-image: linear-gradient(155deg,rgba(201,34,40,1),rgba(209,0,52,1) 11%,rgba(219,0,73,1) 22%,rgba(219,0,91,1) 33%,rgba(219,0,113,1) 44%,rgba(209,0,139,1) 56%,rgba(194,0,165,1));
}
input#header-search {
width: 90%;
margin: 0 auto;
display: block;
background: linear-gradient(302deg,rgba(255,255,255,.12),rgba(255,255,255,0));
border: 3px solid #bd9bd4;
border-radius: 0;
color: #393939;
flex: none;
