...
export default function CompareList() {
  return (
    ...
    <div class='compare-title-container'>
        <div class="compare-title-1"><div class='before-text'>BEFORE</div> <span>MY <span>REVIVAL OF REVENUE</span></span></div>
        <div class="compare-title-vs">VS</div>
        <div class="compare-title-2"><div class='after-text'>AFTER</div> <span>MY <span>REVIVAL OF REVENUE</span></span></div>
    </div>
